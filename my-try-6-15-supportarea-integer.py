    ...
    for i in C:
        for j in C:
            if j != i:
                ...
                model.addConstr(gp.quicksum(eta[f, i, j, k] for f in range(1, 3)) <= 2 * (1 - x[i, j, k]))
            ...
            if m != i:
                for j in C:
                    if j != i and j != m:
                        ...
                        model.addConstr(gp.quicksum(eta[f, i, j, k] for f in range(1, 3)) <= 2 * (1 - y[i, j, m, k]))
                        model.addConstr(gp.quicksum(eta[f, i, j, k] for f in range(1, 3)) <= 2 * (1 - y[m, i, j, k]))
                    ...
                    if j != i and j != m:
                        for i_ in C:
                            if i_ != i and i_ != m and i_ != j:
                                ...
                                model.addConstr(gp.quicksum(eta[f, i, j, k] for f in range(1, 3)) <= 2 * (2 - y[m, i, i_, k] - x[m, j, k]))
